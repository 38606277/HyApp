...
public class MediaFileUtils {
    ...
    public static String getMediaType(String fileName){
        String fileType = "multipart/form-data";//默认格式
        if(!TextUtils.isEmpty(fileName)){
            MediaFileType mediaFileType =  MediaFileUtils.getFileType(fileName);
            if(mediaFileType!=null && !TextUtils.isEmpty(mediaFileType.mimeType)){
